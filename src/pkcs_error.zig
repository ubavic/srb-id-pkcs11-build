...
pub fn toRV(err: PkcsError) pkcs.CK_RV {
    return switch (err) {
        ...
        PkcsError.DEVICE_ERROR => pkcs.CKR_DEVICE_ERROR,
        PkcsError.DEVICE_MEMORY => pkcs.CKR_DEVICE_MEMORY,
        PkcsError.DEVICE_REMOVED => pkcs.CKR_DEVICE_REMOVED,
        ...
        PkcsError.SESSION_CLOSED => pkcs.CKR_SESSION_CLOSED,
        PkcsError.SESSION_COUNT => pkcs.CKR_SESSION_COUNT,
        PkcsError.SESSION_HANDLE_INVALID => pkcs.CKR_SESSION_HANDLE_INVALID,
        ...
        PkcsError.TOKEN_NOT_PRESENT => pkcs.CKR_TOKEN_NOT_PRESENT,
        PkcsError.TOKEN_NOT_RECOGNIZED => pkcs.CKR_TOKEN_NOT_RECOGNIZED,
        ...
        PkcsError.USER_NOT_LOGGED_IN => pkcs.CKR_USER_NOT_LOGGED_IN,
        ...
        PkcsError.CRYPTOKI_NOT_INITIALIZED => pkcs.CKR_CRYPTOKI_NOT_INITIALIZED,
